    ...
    if (!isset($_POST['csrf_token']) || !verify_csrf_token($_POST['csrf_token'])) {
        ...
        if (isset($_POST['approve'])) {
            ...
            if ($assigned_role !== 'User' && $assigned_role !== 'Admin') {
                ...
                // La funzione admin_validate_user_account ora ha il check per is_email_validated
            ...
            $result = admin_reject_pending_user($user_id_action); // Elimina l'utente
            $_SESSION['flash_message'] = $result['message'];
            $_SESSION['flash_type'] = $result['success'] ? 'success' : 'danger';
            $action_taken = true;
        }

        if (!$action_taken && !isset($_SESSION['flash_message'])) { // Nessuna azione valida riconosciuta
...
// La funzione get_pending_validation_users() è già aggiornata per includere is_email_validated
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="admin_users.php" class="btn btn-info"><i class="fas fa-users-cog"></i> Gestisci Tutti gli Utenti</a>
</div>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="admin_pending_users.php" method="POST" class="d-inline-block mb-1">
                        ...
                        <form action="admin_pending_users.php" method="POST" class="d-inline-block">
                            <?php echo csrf_input_field(); ?>
                            <input type="hidden" name="user_id" value="<?php echo $user['id']; ?>">
